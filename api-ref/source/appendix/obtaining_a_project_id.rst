...
-  :ref:`Obtain the Project ID from the Console <dns_api_80007__en-us_topic_0121673684_section11508201712212>`
...
The API used to obtain a project ID is GET https://{Endpoint}/v3/projects. {Endpoint} is the IAM endpoint and can be obtained from the administrator. For details about API authentication, see :ref:`Authentication <dns_api_30003>`.
...
.. _dns_api_80007__en-us_topic_0121673684_section11508201712212:
